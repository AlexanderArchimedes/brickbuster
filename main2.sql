...
-- DROP SCHEMA IF EXISTS `gungo_23749724_BrickBuster` ;
-- CREATE SCHEMA IF NOT EXISTS `gungo_23749724_BrickBuster` DEFAULT CHARACTER SET latin1 ;
-- USE `gungo_23749724_BrickBuster` ;

-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`customers` (
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees1`
    ...
    REFERENCES `gungo_23749724_BrickBuster`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges1`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `gungo_23749724_BrickBuster`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers1`
    ...
    REFERENCES `gungo_23749724_BrickBuster`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status1`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`products` (
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers1`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_inventory_transactions_orders1`
    ...
    REFERENCES `gungo_23749724_BrickBuster`.`orders` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_products1`
    FOREIGN KEY (`product_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`products` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_purchase_orders1`
    FOREIGN KEY (`purchase_order_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`purchase_orders` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_inventory_transaction_types1`
    FOREIGN KEY (`transaction_type`)
    REFERENCES `gungo_23749724_BrickBuster`.`inventory_transaction_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `gungo_23749724_BrickBuster`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions1`
    ...
    REFERENCES `gungo_23749724_BrickBuster`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`sales_reports` (
...
-- -----------------------------------------------------
-- Table `gungo_23749724_BrickBuster`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gungo_23749724_BrickBuster`.`strings` (
